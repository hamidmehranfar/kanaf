...
import '/screens/profile/activate_master_profile_screen.dart';
            ...
            Column(
              children: [
                ...
                ButtonItem(
                  onTap: () {},
                  title: "ویرایش صفحه",
                  color: theme.colorScheme.secondary.withValues(alpha: 0.53),
                ),
                const SizedBox(
                  height: 11,
                ),
                ...
                ButtonItem(
                  onTap: () {
                    Navigator.of(context)
                        .push(MaterialPageRoute(builder: (context) {
                      return const ActivateMasterProfileScreen();
                    }));
                  },
